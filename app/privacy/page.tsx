    ...
    <main className="legal-page">
      ...
      <section className="legal-hero">
        <div>
          ...
          <h1>Privacy for<br />civic action.</h1>
          <p>This policy explains what information Force Against Something collects, why we use it, and the choices available to you.</p>
        </div>
        <aside>
